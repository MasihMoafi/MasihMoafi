...
**AI/ML Engineer** | Building practical AI tools
...
💡 **Tip:** Star repos you find useful!
...
🚀 Featured Projects
🏆 Most Popular
    • A-Modular-Kingdom - Comprehensive MCP Host A-Modular-Kingdom stars

    • Voice Commander - Vocal Prompt Engineer Voice Commander stars

    • Eyes-Wide-Shut - Red-teaming gpt-oss:20b Eyes-Wide-Shut stars

📚 Learning Resources
    • OpenCV Tutorial - Complete CV course OpenCV Tutorial stars

    • ML Exercises - University coursework ML Exercises stars

🔬 Research Projects
    • Financial Market Analysis - Time-series + Transformers
    • Medical Image Segmentation - U-Net architecture
    • Vocal Emotion Recognition - Speech analysis
    • AMR-Abstract-Text_Summarization
💻 Tech Stack
Languages: Python
ML/DL: PyTorch, TensorFlow, Transformers
CV: OpenCV, U-Net
...
📫 Connect
• Twitter • Email •
<p align="center"> <img src="https://github.com/user-attachments/assets/9e3447b1-333c-43b2-bbd1-f369ffde6cb1" alt="image" style="width: 25%; max-width: 200px; height: auto; border-radius: 8px;" /> </p>
